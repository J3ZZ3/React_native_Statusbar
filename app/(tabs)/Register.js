      ...
      >
        <ScrollView contentContainerStyle={styles.ScrollView}>
          ...
          <Pressable style={styles.button} onPress={() => handleOnGetData()}>
            ...
            {
           <View>
              <View style={{gap: 10, textTransform: "uppercase", backgroundColor: "grey", justifyContent: "center", alignItems: "center", padding: 10}}>
                <Text style={{color: "white"}}>Your Details</Text>
